      ...
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-[1fr_160px] gap-4">
          ...
          <div className="space-y-2">
            ...
            <input 
              type="date"
              className="w-full bg-gray-50 border border-gray-200 rounded-xl pl-3 pr-2 py-3.5 outline-none focus:ring-4 focus:ring-brand/10 focus:border-brand focus:bg-white transition-all text-dark font-semibold"
